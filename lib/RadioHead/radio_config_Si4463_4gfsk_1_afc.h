...
// INPUT DATA
/*
// Crys_freq(Hz): 30000000    Crys_tol(ppm): 2.5    IF_mode: 2    High_perf_Ch_Fil: 1    OSRtune: 0    Ch_Fil_Bw_AFC: 1    ANT_DIV: 0    PM_pattern: 0    
// MOD_type: 5    Rsymb(sps): 500    Fdev(Hz): 150    RXBW(Hz): 2000    Manchester: 0    AFC_en: 1    Rsymb_error: 0.0    Chip-Version: 2    
// RF Freq.(MHz): 433.5    API_TC: 29    fhst: 250000    inputBW: 0    BERT: 0    RAW_dout: 0    D_source: 0    Hi_pfm_div: 1    
// 
// # RX IF frequency is  -468750 Hz
// # WB filter 1 (BW =   4.77 kHz);  NB-filter 12 (BW = 1.47 kHz)
// 
...
#define RADIO_CONFIGURATION_DATA_RADIO_PACKET_LENGTH               0x3D
...
*/
#define RF_PREAMBLE_TX_LENGTH_9 0x11, 0x10, 0x09, 0x00, 0x05, 0x14, 0x00, 0x0A, 0x31, 0x00, 0x00, 0x00, 0x00
...
*/
#define RF_SYNC_CONFIG_5 0x11, 0x11, 0x05, 0x00, 0x21, 0xB4, 0x2B, 0x00, 0x00
...
*/
#define RF_PKT_LEN_12 0x11, 0x12, 0x0C, 0x08, 0x00, 0x00, 0x00, 0x30, 0x30, 0x00, 0x3D, 0x14, 0x80, 0x00, 0x00, 0x00
...
*/
#define RF_MODEM_MOD_TYPE_12 0x11, 0x20, 0x0C, 0x00, 0x05, 0x00, 0x07, 0x00, 0x4E, 0x20, 0x05, 0xC9, 0xC3, 0x80, 0x00, 0x00
...
*/
#define RF_MODEM_TX_RAMP_DELAY_8 0x11, 0x20, 0x08, 0x18, 0x05, 0x00, 0x08, 0x03, 0x80, 0x00, 0xF0, 0x11
...
*/
#define RF_MODEM_BCR_OSR_1_9 0x11, 0x20, 0x09, 0x22, 0x01, 0x39, 0x01, 0xA3, 0x6E, 0x00, 0xAE, 0x02, 0x02
...
*/
#define RF_MODEM_AFC_GEAR_7 0x11, 0x20, 0x07, 0x2C, 0x00, 0x12, 0xC0, 0x04, 0x09, 0x2A, 0xE0
...
*/
#define RF_MODEM_AGC_WINDOW_SIZE_9 0x11, 0x20, 0x09, 0x38, 0x11, 0x44, 0x44, 0x00, 0x1A, 0x26, 0x66, 0x00, 0x2A
...
*/
#define RF_MODEM_OOK_CNT1_9 0x11, 0x20, 0x09, 0x42, 0xA4, 0x03, 0xD6, 0x03, 0x00, 0x6E, 0x01, 0xF0, 0xFF
...
*/
#define RF_MODEM_CHFLT_RX1_CHFLT_COE1_7_0_12 0x11, 0x21, 0x0C, 0x0C, 0xFC, 0xFD, 0x15, 0xFF, 0x00, 0x0F, 0xD6, 0xD0, 0xBE, 0xA3, 0x82, 0x61
...
*/
#define RF_MODEM_CHFLT_RX2_CHFLT_COE7_7_0_12 0x11, 0x21, 0x0C, 0x18, 0x41, 0x27, 0x13, 0x06, 0xFF, 0xFD, 0xFD, 0xFD, 0x00, 0x00, 0xF0, 0x0F
...
*/
#define RF_FREQ_CONTROL_INTE_8 0x11, 0x40, 0x08, 0x00, 0x38, 0x0E, 0x66, 0x66, 0x44, 0x44, 0x20, 0xFE

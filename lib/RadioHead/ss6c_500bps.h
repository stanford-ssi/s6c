...
// MOD_type: 3    Rsymb(sps): 500    Fdev(Hz): 250    RXBW(Hz): 20000    Manchester: 0    AFC_en: 1    Rsymb_error: 0.0    Chip-Version: 2    
// RF Freq.(MHz): 433.5    API_TC: 29    fhst: 250000    inputBW: 0    BERT: 0    RAW_dout: 0    D_source: 0    Hi_pfm_div: 1    
// 
// # RX IF frequency is  -468750 Hz
// # WB filter 1 (BW =   4.77 kHz);  NB-filter 15 (BW = 1.08 kHz)
// 
// Modulation index: 1
*/
...
*/
#define RF_PREAMBLE_TX_LENGTH_9 0x11, 0x10, 0x09, 0x00, 0x08, 0x12, 0x00, 0x0A, 0x31, 0x00, 0x00, 0x00, 0x00
...
*/
#define RF_SYNC_CONFIG_5 0x11, 0x11, 0x05, 0x00, 0x31, 0xB4, 0x2B, 0x00, 0x00
...
*/
#define RF_PKT_LEN_12 0x11, 0x12, 0x0C, 0x08, 0x00, 0x00, 0x00, 0x30, 0x30, 0x00, 0x3D, 0x04, 0x00, 0x00, 0x00, 0x00
...
*/
#define RF_MODEM_FREQ_DEV_0_1 0x11, 0x20, 0x01, 0x0C, 0x11
...
*/
#define RF_MODEM_BCR_OSR_1_9 0x11, 0x20, 0x09, 0x22, 0x01, 0x39, 0x01, 0xA3, 0x6E, 0x01, 0xA3, 0x02, 0x00
...
*/
#define RF_MODEM_AGC_WINDOW_SIZE_9 0x11, 0x20, 0x09, 0x38, 0x11, 0x44, 0x44, 0x00, 0x1A, 0x40, 0x00, 0x00, 0x2A
...
*/
#define RF_MODEM_OOK_CNT1_9 0x11, 0x20, 0x09, 0x42, 0xA4, 0x03, 0xD6, 0x03, 0x00, 0x3D, 0x01, 0x80, 0xFF
